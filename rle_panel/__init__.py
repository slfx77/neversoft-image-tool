...
class RlePanel(object):
    def __init__(self):
        self.setup_ui()

    def setup_ui(self):
        self.rle_panel = QtWidgets.QWidget()
        self.rle_panel.setObjectName("rle_panel")
        self.rle_panel_grid_layout = QtWidgets.QGridLayout(self.rle_panel)
        self.rle_panel_grid_layout.setContentsMargins(9, 9, 9, 9)
        self.rle_panel_grid_layout.setObjectName("rle_panel_grid_layout")
        ...
        self.rle_input_label = QtWidgets.QLabel(self.rle_panel)
        self.rle_input_label.setMinimumSize(QtCore.QSize(81, 0))
        self.rle_input_label.setObjectName("rle_input_label")
        self.rle_input_row.addWidget(self.rle_input_label)
        self.rle_input_path = QtWidgets.QLineEdit(self.rle_panel)
        ...
        self.rle_input_browse = QtWidgets.QPushButton(self.rle_panel)
        ...
        self.rle_output_label = QtWidgets.QLabel(self.rle_panel)
        self.rle_output_label.setMinimumSize(QtCore.QSize(81, 0))
        self.rle_output_label.setObjectName("rle_output_label")
        self.rle_output_row.addWidget(self.rle_output_label)
        self.rle_output_path = QtWidgets.QLineEdit(self.rle_panel)
        ...
        self.rle_output_browse = QtWidgets.QPushButton(self.rle_panel)
        ...
        self.rle_convert_button = QtWidgets.QPushButton(self.rle_panel)
        ...
        self.rle_width_label = QtWidgets.QLabel(self.rle_panel)
        ...
        self.rle_width_label.setMinimumSize(QtCore.QSize(51, 0))
        self.rle_width_label.setMaximumSize(QtCore.QSize(30, 16777215))
        self.rle_width_label.setAlignment(QtCore.Qt.AlignRight | QtCore.Qt.AlignTrailing | QtCore.Qt.AlignVCenter)
        self.rle_width_label.setObjectName("rle_width_label")
        self.rle_convert_row.addWidget(self.rle_width_label)
        self.rle_width_selector = QtWidgets.QSpinBox(self.rle_panel)
        self.rle_width_selector.setMaximumSize(QtCore.QSize(70, 16777215))
        ...
        self.rle_file_table = QtWidgets.QTableWidget(self.rle_panel)
        ...
        self.rle_file_table.horizontalHeader().setVisible(False)
        self.rle_file_table.horizontalHeader().setCascadingSectionResizes(False)
        self.rle_file_table.horizontalHeader().setDefaultSectionSize(120)
        self.rle_vertical_layout.addWidget(self.rle_file_table)
        self.rle_progress_bar = QtWidgets.QProgressBar(self.rle_panel)
        ...
        self.rle_panel_grid_layout.addLayout(self.rle_vertical_layout, 0, 0, 1, 1)
        self.rle_input_label.setBuddy(self.rle_input_path)
        self.rle_output_label.setBuddy(self.rle_output_path)
        self.rle_panel.setTabOrder(self.rle_input_path, self.rle_input_browse)
        self.rle_panel.setTabOrder(self.rle_input_browse, self.rle_output_path)
        self.rle_panel.setTabOrder(self.rle_output_path, self.rle_output_browse)
        self.rle_panel.setTabOrder(self.rle_output_browse, self.rle_convert_button)
        self.rle_panel.setTabOrder(self.rle_convert_button, self.rle_width_selector)
        self.rle_panel.setTabOrder(self.rle_width_selector, self.rle_file_table)
