...
class PsxPanel(object):
    def __init__(self):
        self.setup_ui()

    def setup_ui(self):
        self.psx_panel = QtWidgets.QWidget()
        self.psx_panel.setObjectName("psx_panel")
        self.psx_panel_grid_layout = QtWidgets.QGridLayout(self.psx_panel)
        self.psx_panel_grid_layout.setContentsMargins(9, 9, 9, 9)
        self.psx_panel_grid_layout.setObjectName("psx_panel_grid_layout")
        ...
        self.psx_input_label = QtWidgets.QLabel(self.psx_panel)
        ...
        self.psx_input_path = QtWidgets.QLineEdit(self.psx_panel)
        ...
        self.psx_input_browse = QtWidgets.QPushButton(self.psx_panel)
        ...
        self.psx_output_label = QtWidgets.QLabel(self.psx_panel)
        ...
        self.psx_output_path = QtWidgets.QLineEdit(self.psx_panel)
        ...
        self.psx_output_browse = QtWidgets.QPushButton(self.psx_panel)
        ...
        self.psx_extract_button = QtWidgets.QPushButton(self.psx_panel)
        ...
        self.psx_toggle_sub_dirs = QtWidgets.QCheckBox(self.psx_panel)
        ...
        self.psx_file_table = QtWidgets.QTableWidget(self.psx_panel)
        ...
        self.psx_progress_bar = QtWidgets.QProgressBar(self.psx_panel)
        ...
        self.psx_panel_grid_layout.addLayout(self.psx_vertical_layout, 0, 0, 1, 1)
        self.psx_input_label.setBuddy(self.psx_input_path)
        self.psx_output_label.setBuddy(self.psx_output_path)
        self.psx_panel.setTabOrder(self.psx_input_path, self.psx_input_browse)
        self.psx_panel.setTabOrder(self.psx_input_browse, self.psx_output_path)
        self.psx_panel.setTabOrder(self.psx_output_path, self.psx_output_browse)
        self.psx_panel.setTabOrder(self.psx_output_browse, self.psx_extract_button)
        self.psx_panel.setTabOrder(self.psx_extract_button, self.psx_file_table)
        self.psx_panel.setTabOrder(self.psx_file_table, self.psx_toggle_sub_dirs)
